            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Clothing</span>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            {{-- <a href="{{ route('merchandise.index') }}" class="nav-item nav-link">Merchandise</a> --}}
                            {{-- <a href="detail.html" class="nav-item nav-link">Custom Order</a> --}}
                            {{-- <a href="detail.html" class="nav-item nav-link">Bulk Order</a> --}}
