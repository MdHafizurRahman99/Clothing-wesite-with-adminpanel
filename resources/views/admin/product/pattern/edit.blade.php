        ...
        <div class="wizard-v4-content">
            <div class="wizard-form">
                <div class="wizard-header">
                    ...
                    @endif
                    <h3 class="heading">Edit Pattern </h3>
                    {{-- <p>Edit Permissions </p> --}}
                </div>
                <form class="form-register" id="myForm" action="{{ route('pattern.update', ['pattern' => $pattern->id]) }}"
                    method="post">
                    @method('PUT')
                    @csrf
                    <div id="form-total">
                            ...
                            <div class="inner">
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="name" name="name"
                                        value="{{ isset($pattern->name) ? $pattern->name : old('name') }}"
                                        class="form-control" placeholder="Enter Pattern Name">
                                    @error('name')
