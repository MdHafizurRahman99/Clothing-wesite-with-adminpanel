                            ...
                            <div class="inner">
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="name" name="name"
                                        value="{{ old('name', $category->category_name ?? '') }}" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" cols="70" rows="5">{{ old('description', $category->description ?? '') }}</textarea>
