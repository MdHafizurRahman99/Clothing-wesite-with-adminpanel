        ...
        <div class="wizard-v4-content">
            <div class="wizard-form">
                <div class="wizard-header">
                    ...
                    @endif
                    <h3 class="heading">Add Sales Representative </h3>
                    {{-- <p>Add Sales Representatives </p> --}}
                </div>
                            ...
                            <div class="inner">
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="name" name="name" value="{{ old('name') }}"
                                        class="form-control" placeholder="Enter Sales Representative Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="CommissionRate" name="commission_rate"
                                        value="{{ old('commission_rate') }}" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" id="AgreementDetails" name="agreement_details"
                                        value="{{ old('agreement_details') }}" class="form-control"
